...
import { fetchContents } from '../../services/news/api/contents';
import {
  ContentLang,
  ContentListItem,
} from '../../services/news/types/contents';
import useContentHandles from '../../hooks/news/useContentHandles';
import useAdminContentHandles from '../../hooks/news/useAdminContentHandles';
import { messages } from '../../utils/shared/message';
import ContentsPage from '../../components/news/contents/ContentsPage';
import ContentsPageMobile from '../../components/news/contents/ContentsPageMobile';
