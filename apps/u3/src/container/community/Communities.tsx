...
function Header({
  ...
  const getNavUrlWithSort = (type: FeedsType, communityType?: string) => {
    return `/communities/${type}${
      communityType ? `?type=${communityType}` : ''
    }`;
  };
  const typeIsActive = (type: FeedsType) => {
  ...
  return (
    ...
    >
      ...
      >
        <NavLinkItem
          href={getNavUrlWithSort(FeedsType.TRENDING)}
          active={typeIsActive(FeedsType.TRENDING)}
        ...
        >
          ...
          >
            <path
              ...
              fill={typeIsActive(FeedsType.TRENDING) ? '#FFF' : '#718096'}
            />
            <path
        ...
        />
        <NavLinkItem
          href={getNavUrlWithSort(FeedsType.JOINED)}
          active={typeIsActive(FeedsType.JOINED)}
          className="w-auto max-sm:p-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <path
              ...
              fill={typeIsActive(FeedsType.JOINED) ? '#FFF' : '#718096'}
            />
          </svg>
          Joined
        </NavLinkItem>
        ...
        />
        <NavLinkItem
          href={getNavUrlWithSort(FeedsType.NEWEST)}
          active={typeIsActive(FeedsType.NEWEST)}
          className="w-auto max-sm:p-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <g clipPath="url(#clip0_3631_4450)">
              <path
                ...
                fill={typeIsActive(FeedsType.NEWEST) ? '#FFF' : '#718096'}
              />
            </g>
            <defs>
      ...
      <Select2
        ...
        onValueChange={(value) => {
          navigate(getNavUrlWithSort(feedsType, value));
        }}
      />
    </div>
  );
